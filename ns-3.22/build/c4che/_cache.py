...
CFLAGS_PYEMBED = ['-fno-strict-aliasing', '-fwrapv', '-fdebug-prefix-map=/build/python2.7-l1RrwO/python2.7-2.7.14=.', '-fstack-protector-strong', '-fno-strict-aliasing']
CFLAGS_PYEXT = ['-pthread', '-fno-strict-aliasing', '-fwrapv', '-fdebug-prefix-map=/build/python2.7-l1RrwO/python2.7-2.7.14=.', '-fstack-protector-strong', '-fno-strict-aliasing', '-fwrapv', '-fdebug-prefix-map=/build/python2.7-l1RrwO/python2.7-2.7.14=.', '-fstack-protector-strong', '-fno-strict-aliasing']
CFLAGS_cshlib = ['-fPIC']
COMPILER_CC = 'gcc'
COMPILER_CXX = 'g++'
CPPPATH_ST = '-I%s'
...
CXXFLAGS_PYEMBED = ['-fno-strict-aliasing', '-fwrapv', '-fdebug-prefix-map=/build/python2.7-l1RrwO/python2.7-2.7.14=.', '-fstack-protector-strong', '-fno-strict-aliasing']
CXXFLAGS_PYEXT = ['-pthread', '-fno-strict-aliasing', '-fwrapv', '-fdebug-prefix-map=/build/python2.7-l1RrwO/python2.7-2.7.14=.', '-fstack-protector-strong', '-fno-strict-aliasing', '-fwrapv', '-fdebug-prefix-map=/build/python2.7-l1RrwO/python2.7-2.7.14=.', '-fstack-protector-strong', '-fno-strict-aliasing', '-fvisibility=hidden', '-Wno-array-bounds']
...
EXAMPLE_DIRECTORIES = ['tutorial', 'udp', 'stats', 'error-model', 'ipv6', 'udp-client-server', 'tcp', 'matrix-topology', 'socket', 'realtime', 'routing', 'energy', 'naming', 'wireless']
...
NS3_EXECUTABLE_PATH = ['/home/rohan/gitrepo/ns3_offload/ns-3.22/build/src/fd-net-device', '/home/rohan/gitrepo/ns3_offload/ns-3.22/build/src/tap-bridge']
...
NS3_MODULE_PATH = ['/usr/lib/gcc/x86_64-linux-gnu/7', '/home/rohan/gitrepo/ns3_offload/ns-3.22/build']
...
VERSION = '3.22'
WITH_PYBINDGEN = '/home/rohan/gitrepo/ns3_offload/pybindgen-0.17.0.886'
WL_SONAME_SUPPORTED = True
cfg_files = ['/home/rohan/gitrepo/ns3_offload/ns-3.22/build/ns3/config-store-config.h', '/home/rohan/gitrepo/ns3_offload/ns-3.22/build/ns3/core-config.h']
cprogram_PATTERN = '%s'
